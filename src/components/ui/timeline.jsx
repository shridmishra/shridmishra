  ...
  return (
    <div className="w-full bg-slate-950 font-poppins md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-4xl md:text-6xl mb-4 text-white max-w-4xl">
         Details Of Projects
        </h2>
        <div className="text-white text-sm md:text-base max-w-sm">
        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              ...
              <div className="text-white text-9xl">{item.content}</div>
            </div>
          </div>
        ))}
        <div
