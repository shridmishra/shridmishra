          ...
          <div
            ...
            {items.map((item, index) => (
              <motion.div
                ...
                key={"card" + index}
                className="last:pr-[5%] md:last:pr-[33%] rounded-3xl transition-transform duration-300 transform hover:scale-105"
...
export const Card = ({
  ...
  return (
    <>
      ...
      <a
        href={card.link || "https://github.com/shridmishra"} // Use card.link or default to GitHub
        target="_blank"
